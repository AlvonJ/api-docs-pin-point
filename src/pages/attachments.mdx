...
Attachments are how you share things in WhatsApp — they allow you to send all sorts of files to your Attendances {{ className: 'lead' }}

## The attachment model

The attachment model contains all the information about the files you send to your Attendances and groups, including the name, type, and size.
